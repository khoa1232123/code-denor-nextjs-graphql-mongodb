 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation CreateCategory($createCategoryInput: CreateCategoryInput!) {\n  createCategory(createCategoryInput: $createCategoryInput) {\n    ...dataInfo\n  }\n}\n\nmutation UpdateCategory($updateCategoryInput: UpdateCategoryInput!) {\n  updateCategory(updateCategoryInput: $updateCategoryInput) {\n    ...dataInfo\n  }\n}\n\nmutation DeleteCategory($id: String!) {\n  deleteCategory(id: $id) {\n    ...dataInfo\n  }\n}"): (typeof documents)["mutation CreateCategory($createCategoryInput: CreateCategoryInput!) {\n  createCategory(createCategoryInput: $createCategoryInput) {\n    ...dataInfo\n  }\n}\n\nmutation UpdateCategory($updateCategoryInput: UpdateCategoryInput!) {\n  updateCategory(updateCategoryInput: $updateCategoryInput) {\n    ...dataInfo\n  }\n}\n\nmutation DeleteCategory($id: String!) {\n  deleteCategory(id: $id) {\n    ...dataInfo\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query Categories($getCategoriesInput: GetCategoriesInput) {\n  getCategories(getCategoriesInput: $getCategoriesInput) {\n    ...dataInfo\n  }\n}\n\nquery Category($id: String!) {\n  getCategory(id: $id) {\n    ...dataInfo\n  }\n}"): (typeof documents)["query Categories($getCategoriesInput: GetCategoriesInput) {\n  getCategories(getCategoriesInput: $getCategoriesInput) {\n    ...dataInfo\n  }\n}\n\nquery Category($id: String!) {\n  getCategory(id: $id) {\n    ...dataInfo\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
